...
// 	const lightRailRef = useRef<THREE.Mesh>();

// 	useFrame((state) => {
// 		const { leftward, rightward } = getKeys();

// 		if (leftward) {
// 			lightRailRef.current.position.add(new THREE.Vector3(-0.5, 0, 0));
// 			state.camera.position.add(new THREE.Vector3(-0.5, 0, 0));
// 		}
...
// 			lightRailRef.current.position.y + 2, 
// 			lightRailRef.current.position.z,
// 		));
...
//       <mesh castShadow receiveShadow geometry={nodes.Plane.geometry} material={materials['university-base']} position={[-8, 0, 0]} scale={[32, 16, 16]} />
...
//       <mesh castShadow receiveShadow geometry={nodes.lightrail.geometry} material={materials['lr-red']} ref={lightRailRef} scale={[5, 0.75, 1]} />
//     </group>
//   )
// }
