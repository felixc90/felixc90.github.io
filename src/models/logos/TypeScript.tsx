	...
	return (
		<group ref={ref} rotation={[0, -3 * Math.PI / 4, 0]} >
			<mesh scale={1} geometry={nodes['Cube'].geometry}>
				<meshStandardMaterial metalness={0.2} roughness={.1} color={'#3178C6'}/>
			</mesh>
			<Text3D font="./fonts/Logo Fonts/Neutraface-Bold.json" rotation={[0, Math.PI / 2, 0]} position={[.4,-.7,.3]} scale={0.65}>
				TS
