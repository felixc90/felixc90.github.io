...
export function Model() {
	...
	return (
		<group ref={ref} rotation={[0, -Math.PI / 2, 0]} scale={[1.4,1.2,1.2]}>
			<group >
				<mesh scale={1} geometry={nodes['Cylinder'].geometry}>
					<meshStandardMaterial metalness={0.2} roughness={.1} color={'#280068'}/>
				</mesh>
				<mesh scale={1} geometry={nodes['Cylinder002'].geometry}>
					<meshStandardMaterial metalness={0.2} roughness={.1} color={'#390091'}/>
				</mesh>
				<mesh scale={1} geometry={nodes['Cylinder001'].geometry}>
					<meshStandardMaterial metalness={0.2} roughness={.1} color={'#A179DC'}/>
				</mesh>
				<group position={[-.39, 0, 0]}>
					...
					<mesh scale={1} geometry={nodes['Text-#'].geometry}>
						<meshStandardMaterial metalness={0.2} roughness={.1} color={'#fffff'}/>
					</mesh>
				</group>
			</group>
