...
const Contact = () => {
  return (
    <div className="bg-light min-h-screen sm:min-h-[calc(100vh)] px-8 sm:px-16 py-8 text-dark">
          ...
          <div className="flex md:flex-none justify-between">
            <div className="flex w-full flex-col md:flex-row mb-10">
              <div className="w-1/2 pr-4 sm:pr-8 md:pr-12 lg:pr-16 flex md:flex-row-reverse">
                <Title className="text-5xl sm:text-7xl md:text-[5.4rem] lg:text-[7rem]">
                  Have
                </Title>
              </div>
              <Title className="text-5xl sm:text-7xl md:text-[5.4rem] lg:text-[7rem]">
          ...
          <div className="flex w-full flex-col md:flex-row">
            ...
            <div className=" w-full md:w-1/2">
              <MySplitText className="md:text-1xl lg:text-2xl w-4/5 mb-12">
                Got a question to ask, or just want to say hi? I'm always open
                to new opportunities and collaborations — feel free to reach
                out.
              </MySplitText>
              <div>
                <div className="flex gap-1">
                  <Button variant="filled" readonly>
                    EMAIL
                  </Button>
                ...
                <div className="flex gap-3 text-dark">
                  {/* TODO(felix): Update resume */}
                  <IconButton
                    icon={<ResumeIcon />}
                    onClick={() => window.open("/documents/resume.pdf")}
                  />
                  <IconButton
                    icon={<GitHubIcon />}
                    onClick={() =>
                  ...
                  <IconButton
                    ...
                    onClick={() =>
                      window.open(
                        "https://www.linkedin.com/in/felix-cao/",
                        "_blank",
                      )
                    }
                  />
      ...
      <hr className="border-1 border-dashed border-dark/70 my-8 md:my-16" />
    </div>
  );
};
